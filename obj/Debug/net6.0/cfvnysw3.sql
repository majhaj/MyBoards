...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221123094821_Init')
BEGIN
    CREATE TABLE [Tags] (
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221123114507_FullName')
BEGIN
